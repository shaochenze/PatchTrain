...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        #attn_weights = torch.bmm(query_states, key_states.transpose(2, 3)) / math.sqrt(self.head_dim)
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        attention_mask = self._prepare_decoder_attention_mask(
            attention_mask, (batch_size, num_patches), inputs_embeds, past_key_values_length
        )
